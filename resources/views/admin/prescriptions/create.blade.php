    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.prescriptions.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('medication') ? 'is-invalid' : '' }}" name="medication" id="medication">{!! old('medication') !!}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('dosage') ? 'is-invalid' : '' }}" name="dosage" id="dosage">{!! old('dosage') !!}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('duration') ? 'is-invalid' : '' }}" name="duration" id="duration">{!! old('duration') !!}</textarea>
